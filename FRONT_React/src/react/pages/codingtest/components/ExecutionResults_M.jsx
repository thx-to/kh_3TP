...
import { ExecutionResultsStyles as CssWrapper } from "../../../styles/codingtest/ExecutionResultsStyles_M";

const ExecutionResults_M = ({ results }) => {
...
export default ExecutionResults_M;
