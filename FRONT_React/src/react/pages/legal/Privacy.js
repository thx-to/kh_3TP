...
import Privacy_M from "./Privacy_M";
            ...
            <BodyContainer>
              ...
              <Chapter>
                <Item>
                  ...
                  보호법」 등 관련 법령상의 개인정보 보호규정을 준수하고
                  있습니다. 회사는 「개인정보 보호법」 제30조에 따라 이용자의
                  개인정보를 보호하고 이와 관련된 고충을 신속하고 원활하게
                  처리할 수 있도록 하기 위하여 아래와 같이 개인정보 처리방침을
                  명시하며, 이용자의 권익 보호에 최선을 다할 것입니다. 본
                  개인정보 처리방침은 회사의 개인 이용약관 및 기업 이용약관
              ...
              <Chapter>
                <Article>
                  ...
                  <Item>
                    회사는 필요한 한도 내에서 최소한의 개인정보를 수집하며,
                    ...
                    <ItemTab>
                      ...
                      <ItemTab>
                        ...
                        확인, 회원 자격 유지, 회원 자격 관리, 서비스 부정 이용
                        및 비인가 사용 방지, 상담 및 문의 처리, 각종 고지/통지
                        등을 목적으로 개인정보를 처리합니다.
                        <br />
                      </ItemTab>
                      2. 재화 등 서비스 제공
                      ...
                      <ItemTab>
                        ...
                        정보의 전달(채용 합∙불합 결과, 테스트 결과 등), 회원
                        간의 상호 연락, 서비스 구매 및 요금 결제, 계약서 발송,
                        청구서 발송, 콘텐츠 제공, 물품 및 증빙 발송 등을
                        목적으로 개인정보를 처리합니다.
                        <br />
                      </ItemTab>
                      ...
                      <br />
                      <ItemTab>
                        맞춤 서비스 제공, 서비스 안내 및 이용권유, 서비스 개선
                        및 신규 서비스 개발을 위한 통계 및 접속빈도 파악, 유료
                        서비스 구매 및 이용 시 요금 정산, 통계학적 특성에 따른
                        광고 게재, 이벤트 정보 및 참여기회 제공
                        <br />
                      </ItemTab>
                ...
                <Article>
                  ...
                  <Item>
                    ...
                    정보주체로부터 개인정보의 수집 시에 동의 받은 개인정보를
                    이용 기간 내에서 처리, 보유합니다. 각각의 개인정보 처리 및
                    보유 기간은 다음과 같습니다.
                    <br />
                    <br />
                    <ItemTab>
                      ...
                      <br />
                      <ItemTab>
                        가. 온라인/모바일 서비스 제공을 위해 수집한 회원가입
                        정보 : 회원탈퇴 시까지
                        <br />
                        나. 개별적으로 이용자의 동의를 받은 경우 : 동의를 받은
                        기간
                        <br />
                        다. 회사와 이용자 간에 민원, 소송 등 분쟁이 발생한
                        경우에 그 보유기간 내에 분쟁이 해결되지 않을 경우 : 그
                        분쟁이 해결될 때까지
                        <br />
                      </ItemTab>
                ...
                <Article>
                  ...
                  <Item>
                    <ItemTab>
                      ...
                      제17조(개인정보의 제공)에 해당하는 경우에만 개인정보를
                      제3자에게 제공합니다.
                      <br />
                ...
                <Article>
                  ...
                  <Item>
                    회사는 원활한 서비스 제공을 위해 개인정보를 타인에게 위탁할
                    수 있습니다. 필요한 경우 수탁업체가 변경될 수 있으며, 이
                    경우 본 개인정보 처리방침에 변경 사항을 반영하여 고지합니다.
                  </Item>
                </Article>
                    ...
                    <ItemTab>
                      ...
                      <ItemTab>
                        ...
                        <ItemTab>
                          ...
                          담당자에게 서면 또는 전자우편으로 연락하는 경우
                          지체없이 조치하도록 하겠습니다. 다만, 정보주체는 다른
                          법령에서 그 개인정보가 수집대상으로 명시되어 있는
                          경우에는 삭제를 요구할 수 없으며, 개인정보를
                          정정・삭제하는 경우 일부 또는 전부의 서비스 이용이
                          불가능할 수 있습니다.
                          <br />
                        </ItemTab>
                        나. 개인정보 처리정지 요구의 권리
                        ...
                        <ItemTab>
                          ...
                          개인정보 처리의 정지를 원하는 경우 회사의 개인정보
                          보호 책임자 및 담당자에게 서면 또는 전자우편으로
                          연락하는 경우 지체 없이 조치하도록 하겠습니다. 다만,
                          회사는 관련 법령에 따라 이용자의 처리정지 요구에도
                          불구하고 계속하여 개인정보를 처리할 수 있으며, 이러한
                          경우에는 지체 없이 그 내용을 정보주체에게 알리도록
                          하겠습니다.
                          <br />
                        </ItemTab>
                      ...
                      위임을 받은 자 등 대리인을 통하여서 할 수 있습니다. 이
                      경우 「개인정보 보호법」에서 정한 서식에 따른 위임장을
                      제출해야 합니다.
                      <br />
                    </ItemTab>
                  </Item>
                ...
                <Article>
                  ...
                  <Item>
                    <ItemTab>
                      1. 회사는 코디터 회원 및 서비스 분류에 따라 다음의
                      개인정보 항목을 수집, 이용, 보유, 파기하고 있습니다.
                      회원은 본 조의 선택 항목 제공 동의를 거부할 권리가 있으며,
                      미동의 시 서비스 가입/이용에 제약이 있을 수 있습니다.
                      <br />
                      <ItemTab>
                        가. 코디터 회원
                        <br />
                        <ItemTab>
                          ...
                          <ItemTab>
                            ...
                            소개, 홈페이지, 활동 지역, 페이스북 등 외부
                            서비스와의 연동을 위해 이용자가 설정한 계정 정보,
                            본인확인값(CI, DI), 마케팅 정보 수신 동의(이메일)
                            <br />
                          </ItemTab>
                          ②. 회원가입(제휴사 계정)
                          <br />
                          ...
                          <ItemTab>
                            ...
                            학위, 기간, 졸업 여부, 기타 설명), 외국어
                            능력(외국어 이름, 활용능력, 어학시험 점수)
                            <br />
                          </ItemTab>
                          ⑥. 유료 서비스 이용
                          <br />
                      ...
                      2. 인터넷 서비스 이용과정에서 아래 개인정보 항목이
                      자동으로 생성되어 수집될 수 있습니다.
                      <br />
                      <ItemTab>
                        가. IP 주소, 쿠키, 서비스 이용 기록, 방문 기록, 불량
                        이용 기록 등
                        <br />
                      </ItemTab>
                    </ItemTab>
                    ...
                    <ItemTab>
                      ...
                      <ItemTab>
                        ...
                        <ItemTab>
                          ...
                          이용자의 관심 분야를 파악 및 자취 추적, 각종 이벤트
                          참여 정도 및 방문 횟수 파악 등을 통한 개인 맞춤 서비스
                          제공
                          <br />
                        </ItemTab>
                        나. 쿠키 설정 거부 방법
                      ...
                      2. 회사는 서비스 세션(session)을 통하여 이용자의 정보를
                      얻고 있습니다. 세션이란, 이용자가 “서비스” 사이트를 방문할
                      때 “서비스”의 서버 로부터 이용자의 컴퓨터에 보내진 시스템
                      파일로서 이용자의 연결 유지를 위하여 잠시 이용자의
                      컴퓨터에 머무는 파일입니다. 이러한 세션은 현재 연결의
                      유지에만 사용되며 브라우저를 종료할 경우 삭제됩니다.
                      <br />
                    </ItemTab>
                  </Item>
                </Article>
                    ...
                    <ItemTab>
                      ...
                      <ItemTab>
                        ...
                        <ItemTab>
                          ...
                          처리 및 보유기간 참조) 동안 안전하게 보관된 후
                          지체없이 파기됩니다. 이때, DB로 옮겨진 개인정보는
                          법률에 의한 경우를 제외하고 다른 목적으로 이용하지
                          않습니다.
                          <br />
                        </ItemTab>
                        나. 파기 방법
                ...
                <Article>
                  ...
                  <Item>
                    ...
                    도난, 유출, 위조, 변조 또는 훼손되지 않도록 개인정보의
                    안전성 확보를 위하여 다음과 같은 기술적/관리적 대책을
                    강구하고 있습니다.
                    <br />
                    <br />
                    <ItemTab>
                      ...
                      <ItemTab>
                        ...
                        훼손을 막기 위하여 보안 프로그램을 설치하고 주기적으로
                        점검하고 있습니다.
                        <br />
                      </ItemTab>
                    </ItemTab>
                ...
                <Article>
                  ...
                  <Item>
                    <ItemTab>
                      ...
                      등을 위해 아래와 같이 개인정보 보호 담당 부서를 지정하고
                      있습니다. 고객의 개인정보와 관련한 문의 사항이 있으면
                      코디터에 연락 주시기 바랍니다.
                      <br />
                      2. 기타 개인정보 침해에 대한 피해 구제, 상담은 아래의
                      기관에 문의하실 수 있습니다.
                      <br />
                      <ItemTab>
                ...
                <Article>
                  ...
                  <Item>
                    ...
                    시행령 제31조에 따라 개정 내용을 회사 홈페이지 또는
                    전자우편을 통해 공개하겠습니다.
                  </Item>
                </Article>
              </Chapter>
