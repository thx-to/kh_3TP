...
import { CodeChallengeInfoStyles as CssWrapper } from "../../../styles/codingtest/CodeChallengeInfoStyles_M";

const CodeChallengeInfo_M = ({ setHeaderTitle, setCodeEditorValue }) => {
...
export default CodeChallengeInfo_M;
