  ...
  return (
    <Wrap>
      ...
      <Container>
        ...
        <ClassContentsText>
          프로그래밍은 문제를 해결하기 위해 컴퓨터 프로그램을 설계하고 개발하는
          전체 과정을 의미합니다.
        </ClassContentsText>
        <hr />
        <ClassContentsText>
          <ClassContentsTextTab>
            ...
            <br />
            3. 알고리즘 설계 : 문제를 해결하기 위한 논리적인 단계를 설계합니다.
            <br />
        ...
        <ClassContentsText>
          <ClassContentsTextTab>
            ...
            프로그래밍 요소가 강화되었습니다.
            <br />
            - 자바 11 (2018년) : LTS(Long-Term Support) 버전으로, 새로운 HTTP
            클라이언트, var 키워드 등이 추가되었습니다.
            <br />
            - 자바 17 (2021년) : 최신 LTS 버전으로, 패턴 매칭, 레코드, sealed
            클래스 등이 추가되었습니다.
            <br />
          </ClassContentsTextTab>
        </ClassContentsText>
        ...
        <ClassContentsText>
          <ClassContentsTextTab>
            1. 운영체제 독립성 : JVM을 통해 어느 운영체제에서나 동일하게 실행할
            수 있습니다.
            <br />
            ...
            있습니다.
            <br />
            5. 네트워크, 멀티스레드, 동적 로딩 지원 : 다양한 기능을 쉽게 구현할
            수 있습니다.
            <br />
          </ClassContentsTextTab>
        </ClassContentsText>
        ...
        <ClassContentsText>
          <ClassContentsTextTab>
            1. 실행 속도 : JVM을 통해 실행되므로 다른 언어보다 속도가 느릴 수
            있습니다.
            <br />
            2. 예외 처리 : 예외 처리를 개발자가 직접 지정해야 하므로 번거로울 수
            있습니다.
            <br />
        ...
        <ClassContentsText>
          <ClassContentsTextTab>
            - 이식성 : 자바로 개발된 프로그램은 JRE(Java Runtime Environment)가
            설치된 모든 운영체제에서 실행 가능합니다.
            <br />
            - 객체 지향 언어 : 객체를 먼저 만들고, 이를 조립해 전체 프로그램을
            완성하는 기법을 사용합니다.
            <br />
            - 함수형 프로그래밍 지원 : 자바는 함수형 프로그래밍을 위해 람다식을
            지원하여 코드가 간결해지고 병렬 처리가 용이해집니다.
            <br />
            - 메모리 자동 관리 : 개발자가 직접 메모리를 관리하지 않으며, 자바가
            자동으로 할당 및 해제합니다.
            <br />
            - 멀티 스레드 지원 : 자바는 멀티 스레드를 쉽게 구현할 수 있도록 관련
            API를 제공합니다.
            <br />
            - 동적 로딩 : 객체가 필요한 시점에 클래스를 동적으로 로딩하여 객체를
            생성합니다.
            <br />
          </ClassContentsTextTab>
        </ClassContentsText>
        ...
        <ClassContentsText>
          컴파일은 사람이 이해하는 언어로 작성된 소스 코드를 컴퓨터가 이해할 수
          있는 기계어로 번역하는 과정입니다. 자바 컴파일러는 자바 소스 코드를
          JVM이 이해할 수 있는 바이트 코드로 변환합니다.
        </ClassContentsText>
        <ClassContentsImage
          style={{
        ...
        <ClassContentsText>
          <ClassContentsTextTab>
            - JDK(Java Development Kit) : JRE와 개발 도구(컴파일러, 디버거 등)를
            포함합니다.
            <br />
            - JRE(Java Runtime Environment) : JVM과 자바 프로그램 실행에 필요한
            라이브러리를 포함합니다.
            <br />
            - JVM(Java Virtual Machine) : 운영체제별로 제공되며, 바이트 코드를
            읽고 실행합니다.
            <br />
          </ClassContentsTextTab>
        </ClassContentsText>
        ...
        <ClassContentsText>
          <ClassContentsTextTab>
            ...
            빌드 작업을 자동화합니다.
            <br />
            - Gradle : Groovy 스크립트를 사용하는 빌드 도구로, 유연한 빌드 작업
            정의가 가능하며 멀티 프로젝트 관리에 용이합니다.
            <br />
          </ClassContentsTextTab>
          <br />
          빌드 툴은 프로젝트의 의존성 관리, 빌드 설정, 테스트 실행, 배포 등을
          자동화하여 일관된 방식으로 작업할 수 있도록 도와줍니다.
        </ClassContentsText>
        {/* </ClassContentsContainer> */}
        {/* </EachClass> */}
        <ArrowContainer>
