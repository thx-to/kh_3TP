      ...
      <Container>
        ...
        <ClassContentsText>
          <ClassContentsTextTab>
            ...
            코드일지라도 기본적인 구성을위해 많은 코딩이 필요합니다. 이부분은
            파이썬 언어와 대비되는 부분 입니다.
            <br />
            <br />
            <Java_01_03_Code02 />
        ...
        <ClassContentsText>
          ...
          <br />
          static은 정적변수를 의미하며 객체로 생성이 불가능 하고 유일하다는 의미
          입니다.
          <br />
          void는 메소드의 실행결과로 아무것도 되돌려 주지 않는 다는 의미 입니다.
          <br />
          String[]은 문자열이 배열로 이루어져 있다는 의미로 여러개의 문자열을
          입력 받을 수 있다는 의미 입니다.
          <br />
        </ClassContentsText>
        ...
        <ClassContentsText>
          자바 프로그램의 동작을 명시하고, 이러한 동작을 컴퓨터에게 알려주는데
          사용되며 반드시 (;)세미콜론으로 끝나야 합니다.
        </ClassContentsText>
        <br />
        <ClassContentsTitle2>자바 표준 출력 클래스</ClassContentsTitle2>
        <ClassContentsText>
          <ClassContentsTextTab>
            - 자바의 표준 출력 클래스는 print(), println(), printf() 세가지의
            메소드가 있습니다.
            <br />
