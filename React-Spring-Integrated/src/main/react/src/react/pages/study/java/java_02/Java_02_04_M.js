    ...
    <Wrap>
      ...
      <TopBoxWide2>
        <TopBox2>
          ...
          <TopBoxText2 onClick={() => handleRefresh()}>04. 조건문</TopBoxText2>
        </TopBox2>
      </TopBoxWide2>
      <Container>
        {/* <EachClass>
        ...
        <ClassContentsText>
          프로그램이 원하는 결과를 얻기 위해서는 프로그램의 순차적인 흐름을
          제어해야만 할 경우가 생깁니다.
          <br />
          이때, 사용하는 명령문을 제어문이라고 하며, 이러한 제어문에는{" "}
          <b>조건문, 반복문</b> 등이 있습니다.
          <br />
          이러한 제어문에 속하는 명령문들은 중괄호{}로 둘러싸여 있으며, 이러한
          중괄호 영역을 블록(block)이라고 합니다.
          <br />
          <br />
          <ClassContentsTextTab>
            ...
            <br />-{" "}
            <i>
              선택 구조 : 입력 받은 값에 따라 선택하여 실행되는 구조 (조건문)
            </i>
            <br />-{" "}
        ...
        <ClassContentsText>
          조건문은 주어진 조건식의 결과에 따라 별도의 명령을 수행하도록 제어하는
          명령문입니다. <br />
        ...
        <ClassContentsText>
          switch문은 if문과 마찬가지로 조건 제어문 입니다. switch문의 if문 처럼
          조건식이 true일 때 블록 내부의 실행문을 실행하는 것이 아니라, 변수가
          어떤 값을 갖는냐에 따라 실행문이 선택 됩니다.
          <br />
          <br />
          <ClassContentsTextTab>
        ...
        <ClassContentsText>
          · 시험 성적을 입력 받아 90 ~ 100점은 A, 80 ~ 89점은 B, 70 ~ 79점은 C,
          60 ~ 69점은 D, 나머지는 F를 출력하는 프로그램
          <br />
        ...
        <ClassContentsText>
          ...
          · 입력된 이름, 제목, 날짜, 시간 정보와 계절 정보를 이용하여 다음과
          같은 형식으로 일정 정보를 출력합니다.
          <br />
          <br />
          <b>[힌트]</b>
          <br />
