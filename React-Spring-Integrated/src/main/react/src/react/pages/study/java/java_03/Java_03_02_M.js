    ...
    <Wrap>
      ...
      <TopBoxWide2>
        <TopBox2>
          ...
          <TopBoxText2 onClick={() => handleRefresh()}>02. 배열</TopBoxText2>
        </TopBox2>
      </TopBoxWide2>
      <Container>
        {/* <EachClass>
        ...
        <ClassContentsText>
          자바의 배열은 동일한 타입의 데이터 요소들을 연속적으로 저장하는 자료
          구조 입니다. 배열은 여러 개의 값을 하나의 변수에 저장할 수 있도록
          해주며, 인덱스를 사용하여 각 요소에 접근할 수 있습니다. 자바에서
          배열은 기본 자료형과 객체 타입 모두에 대해 사용 할 수 있습니다.
          <br />
          자바 배열은 객체로 취급되며, 기본적으로 힙(Heap) 영역에 메모리가
          할당되고 사용됩니다. 배열의 크기를 지정하여 사용 합니다.
          <br />
          <ClassContentsCode>
            타입[] 배열이름 = new 타입[배열길이];
          </ClassContentsCode>
        ...
        <ClassContentsText>
          ...
          <br />
          배열 변수는 참조 변수이며, 배열도 객체 이므로 힙 영역에 생성되고, 힙
          역역의 배열 객체를 참조 합니다.
          <br />
          즉, 참조 변수는 스택영역이고 힙영역에 배열에 저장될 값에 대한 메모리가
          할당 됩니다.
          <br />
        ...
        <ClassContentsTitle2>배열의 선언과 초기화</ClassContentsTitle2>
        <ClassContentsText>
          <ClassContentsCode>타입[ ] 변수 = null;</ClassContentsCode> 배열
          변수는 참조 변수에 속합니다. 배열도 객체이므로 힙 영역에 생성되고 배열
          변수는 힙 영역의 배열 객체를 참조하게 됩니다.
          <Java_03_02_Code03 />
          <Java_03_02_Code04 />
        </ClassContentsText>
        ...
        <ClassContentsText>
          ...
          코드에서 배열의 길이를 얻으려면 배열 객체의 length 필드를 읽습니다.
        ...
        <ClassContentsText>
          ...
          />
          인텔리제이 상단 오른쪽의 실행 매뉴의 클래스명을 눌러 구성편집으로 진입
          합니다.
          <ClassContentsImage
            style={{
              width: "100%",
        ...
        <ClassContentsText>
          생성된 배열 공간의 각 저장공간을 요소하고 부르며, 배열이름[인덱스]
          형식으로 요소에 접근 할 수 있습니다.
          <br />
          <b>배열의 인덱스는 0에서 부터 배열의 길이 -1까지 지정</b> 됩니다.
        </ClassContentsText>
        ...
        <ClassContentsText>
          아마 여러분이 자바 코드를 작성하면서 보게 될 가장 많은 오류중의 하나는
          바로 다음의 오류일 것이다.
          <ClassContentsCodeBox>
            ArrayIndexOutOfBoundsException
          </ClassContentsCodeBox>
          다음의 예처럼 요일 배열의 길이는 총 7개인데 만약 8번째 값을 얻으려고
          시도하면 이와 같은 오류가 발생한다.
          <ClassContentsCodeBox>
        ...
        <ClassContentsText>
          <ClassContentsCode>int[][] arr = new int[2][3];</ClassContentsCode>
        </ClassContentsText>
        <ClassContentsImage
          style={{
            width: "100%",
        ...
        <ClassContentsText>
          1차원 배열과 마찬가지로 2차원 배열도 선언과 동시에 초기화 할 수
          있습니다.
          <Java_03_02_Code10 />
        </ClassContentsText>
        <ClassContentsTitle2>객체를 참조하는 배열</ClassContentsTitle2>
        <ClassContentsText>
          기본 타입의 배열은 각 항목에 직접 값을 가지고 있지만, 참조 타입 배열은
          각 항목에 객체의 번지를 가지고 있습니다.
          <Java_03_02_Code11 />
        </ClassContentsText>
        ...
        <ClassContentsText>
          ...
          <br />
          루프 마다 각 요소는 명시한 변수의 이름으로 저장되며, 명령문에서는 이
          변수를 사용하여 각 요소를 참조할 수 있습니다.
          <br />
          Enhanced for 문은 요소를 참조할 때만 사용하는 것이 좋으며, 요소의 값을
          변경하는 작업에는 적합하지 않습니다.
          <Java_03_02_Code12 />
        </ClassContentsText>
        <ClassContentsTitle2>
        ...
        <ClassContentsText>
          자바에서 배열은 한 번 생성하면 그 길이를 변경 할 수 없습니다.
          <br />더 많은 데이터를 저장하기 위해서는 더욱 큰 배열을 만들고, 이전
          배열의 데이터를 새로 만든 배열로 복사해야 합니다.
          <br />
          ...
          중에서 가장 좋은 성능을 보이는 것은 배열의 복사만을 위해 만들어진
          arraycopy() 메소드입니다.
          <br />
          하지만 현재 배열의 복사를 위해 가장 많이 사용되는 메소드는 좀 더
          유연한 방식의 copyOf() 메소드입니다.
          <br />
          arraycopy(), copyOf() 메소드와 for 문을 이용한 복사는 배열의 길이를
          마음대로 늘일 수 있습니다.
          <br />
          하지만 clone() 메소드는 이전 배열과 같은 길이의 배열밖에 만들 수
          없습니다.
        </ClassContentsText>
        ...
        <ClassContentsText>
          객체의 주소 값만 가져와 참조형 변수에 저장하고 하나의 객체를 주소
          변수가 참조하는 것을 의미 합니다.
          <Java_03_02_Code17 />
          <ClassContentsImage
            style={{
        ...
        <ClassContentsText>
          7개의 정수를 입력 받아 홀수와 짝수를 각 배열에 나누어 저장 후
          출력합니다.
          <Java_03_02_Code20 />
        </ClassContentsText>
        {/* </ClassContentsContainer>
