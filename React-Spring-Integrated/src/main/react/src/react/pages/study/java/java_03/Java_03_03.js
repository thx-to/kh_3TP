...
import Java_03_03_M from "./Java_03_03_M";
        ...
        <Wrap>
          ...
          <Container>
            ...
            <RightContainer>
              <EachClass>
                <ClassHeader>
                  <ClassHeaderTitle>String</ClassHeaderTitle>
                </ClassHeader>
                <ClassContentsContainer>
                  <ClassContentsText>
                    자바의 문자열을 나타내는 자료형은 String이며,{" "}
                    <b>참조 타입 자료형</b> 입니다.
                    <br />
                    문자열을 표현하기 위해서는{" "}
                    <b>객체를 만들어 사용하거나 리터럴 표기 방식으로 사용</b>할
                    수 있으며, 리터럴 표기 방식이 가독성이나 컴파일 시 성능에
                    유리한 점이 있습니다.
                  </ClassContentsText>
                  <ClassContentsTitle3>
                    문자열이란 문장을 의미합니다.
                  ...
                  <ClassContentsText>
                    ...
                    는 같은 값을 갖게 되지만 완전히 동일하지는 않다. 첫번째
                    방식을 리터럴(literal) 표기라고 하는데 객체 생성없이 고정된
                    값을 그대로 대입하는 방법을 말한다. 위 예에서 리터럴
                    표기법은 "happy java" 라는 문자열을 internal pool 이라는
                    곳에 저장하고 다음에 다시 동일한 문자열이 선언될때는 cache
                    된 문자열을 리턴한다. 두번째 방식은 항상 새로운 String
                    객체를 만든다.
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    <b>문자열에서 특정 문자가 시작되는 인덱스를 리턴</b>합니다.
                    (0부터 시작 합니다.)
                    <Java_03_03_Code07 />
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    ...
                    사용한다.
                    <br />
                    대체할 문자열에 대해 “”하면 해당 문자열을 찾아서 지울 수도
                    있습니다.
                    <Java_03_03_Code10 />
                  </ClassContentsText>
                  ...
                  <ClassContentsText>
                    ...
                    <br />
                    출력 포맷이 정해져 있고 특정한 값만 계속되는 경우 사용하면
                    됩니다.
                    <br />
                    <ClassContentsCode>String.format</ClassContentsCode>과{" "}
                    <ClassContentsCode>System.out.printf</ClassContentsCode>의
                    차이는 전자는 문자열을 리턴하는 메소드이고 후자는 문자열을
                    출력하는 메소드라는 점이다.
                  </ClassContentsText>
