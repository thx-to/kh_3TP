...
import Java_03_04_M from "./Java_03_04_M";
        ...
        <Wrap>
          ...
          <Container>
            ...
            <RightContainer>
              <EachClass>
                <ClassHeader>
                  <ClassHeaderTitle>✏️ 예제 : 회원정보</ClassHeaderTitle>
                </ClassHeader>
                <ClassContentsContainer>
                  <ClassContentsText>
                    <font color="#2c79c1">
                      <i>
                        지금까지 배운 내용을 복습하고 앞으로 배울 클래스에 대해
                        미리 사용해 보는 예제입니다.
                      </i>
                    </font>
                  </ClassContentsText>
                  ...
                  <ClassContentsText>
                    ...
                    <br />- 값이 변경되지 않는 자료형에 대해서는 상수로 선언
                    한다.
                  ...
                  <ClassContentsText>
                    ...
                    <br />- 나이는 정수타입으로 입력 받는다. 나이는 0 ~
                    199까지만 정상적인 값으로 판단하고 다른 숫자가 입력되면 재
                    입력 요구를 한다. 단, 숫자 입력 요구에서 문자가 입력되면
                    오류가 발생하는데 이 부분에 대해서 나중에 학습 하도록 한다.
                    <br />- 성별은 문자 타입으로 입력 받는다. 남성은 ‘M’, ‘m’,
                    여성은 ‘F’, ‘f’
                    <br />
                    - 성별에 대한 출력은 “남성"과 “여성" 문자열로 출력 한다.
                    <br />- 직업은 정수로 입력(1 ~ 4) 받고 1은 “학생, 2는
                    “회사원", 3은 “주부", 4는 “무직"으로 출력 한다.
                    <br />- 1 ~ 4사이의 숫자가 아니면 재 입력 요구를 하도록
                    한다.
                    <br />- 결과는 한번에 출력 한다.
                    <Java_03_04_Code01 />
                    <Java_03_04_Code02 />
