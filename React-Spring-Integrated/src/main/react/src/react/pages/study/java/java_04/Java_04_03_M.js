    ...
    <Wrap>
      ...
      <Container>
        {/* <EachClass>
            ...
            <ClassContentsContainer> */}
        <ClassContentsTitle1>메소드 연습(영화표 예매)</ClassContentsTitle1>
        <ClassContentsTitle3>문제 설명</ClassContentsTitle3>
        <ClassContentsText>
          간단한 영화표사용자가 영화의 좌석을 선택하고 선택한 좌석 수에 따라 총
          금액을 계산합니다. 예매 시스템에 대한 예제입니다.
          <br />
          사용자가 영화의 좌석을 선택하고 선택한 좌석 수에 따라 총 금액을
          계산합니다.
        </ClassContentsText>
        ...
        <ClassContentsText>
          - 예매하기와 종료하기 메뉴 작성
          <br />- 극장의 좌석은 10개 입니다.
          <br />- 각 좌석당 판매 가격은 12000원 입니다. (판매 금액은 생성자를
          통해서 정의)
        </ClassContentsText>
        ...
        <ClassContentsText>
          ...
          <ClassContentsTextTab>
            ...
            <ClassContentsCode>MovieTicket</ClassContentsCode> 클래스는 영화
            티켓 예매 시스템을 나타내며, 내부에 메서드들이 정의되어 있습니다.
          </ClassContentsTextTab>
          2. <b>배열</b>
          <br />
          <ClassContentsTextTab>
            <ClassContentsCode>int[] seat</ClassContentsCode>는 10개의 정수로
            이루어진 배열을 선언하며, 좌석의 예약 상태를 나타냅니다.
          </ClassContentsTextTab>
          3. <b>메서드 호출</b>
          <br />
          <ClassContentsTextTab>
            <ClassContentsCode>ticket.selectSeat()</ClassContentsCode>와 같이
            메서드를 호출하여 해당 메서드의 코드 블록을 실행합니다.
          </ClassContentsTextTab>
          4. <b>조건문</b>
          <br />
          <ClassContentsTextTab>
            <ClassContentsCode>if</ClassContentsCode>,{" "}
            <ClassContentsCode>else</ClassContentsCode>문을 사용하여 조건에 따라
            다른 코드 블록을 실행합니다.
          </ClassContentsTextTab>
          5. <b>반복문</b>
          <br />
          <ClassContentsTextTab>
            <ClassContentsCode>while(true)</ClassContentsCode> 루프를 사용하여
            무한 루프를 만들고, 조건에 따라 반복하거나 중단합니다.
          </ClassContentsTextTab>
          6. <b>입출력</b>
          <br />
          <ClassContentsTextTab>
            <ClassContentsCode>Scanner</ClassContentsCode> 클래스를 사용하여
            사용자로부터 입력을 읽어들이고,{" "}
            <ClassContentsCode>System.out.println()</ClassContentsCode>을
            사용하여 출력을 화면에 표시합니다.
          </ClassContentsTextTab>
          7. <b>배열 반복문</b>
          <br />
          ...
          <br />
          <ClassContentsTextTab>
            <ClassContentsCode>MovieTicket</ClassContentsCode> 클래스의 생성자는
            코드에서는 보이지 않지만, 자바에서는 클래스 내에 생성자를 정의하여
            객체의 초기화를 수행할 수 있습니다.
          </ClassContentsTextTab>
          <br />
          <Java_04_03_Code01 />
