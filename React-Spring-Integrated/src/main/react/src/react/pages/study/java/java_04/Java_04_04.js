...
import Java_04_04_M from "./Java_04_04_M";
        ...
        <Wrap>
          ...
          <Container>
            ...
            <RightContainer>
              <EachClass>
                <ClassHeader>
                  <ClassHeaderTitle>this & this()</ClassHeaderTitle>
                </ClassHeader>
                <ClassContentsContainer>
                  <ClassContentsTitle2>this 참조 변수</ClassContentsTitle2>
                  <ClassContentsText>
                    <b>
                      this 참조 변수는 인스턴스가 자기 자신을 참조하는데
                      사용하는 변수
                    </b>
                    입니다. (자신의 메모리를 가리키는 this)
                    <br />
                    아래의 예제처럼 생성자의 매개변수 이름과 인스턴스 변수의
                    이름이 같을 경우에는 인스턴스 변수 앞에 this 키워드를 붙여
                    구분해야만 합니다.
                    <br />
                    <b>
                      this 참조자를 사용 할 수 있는 영역은 인스턴스 메소드 뿐
                    </b>
                    이며, 클래스 메소드에서는 사용 할 수 없습니다.
                    <br />
                    모든 인스턴스 메소드에는{" "}
                    <b>this 참조 변수가 숨겨진 지역 변수로 존재</b>하고
                    있습니다.
                    <Java_04_04_Code01 />
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    생성자 오버로딩이 많아 질 경우 생성자 간의 중복된 코드가
                    발생 할 수 있습니다.
                    <br />
                    ...
                    <br />
                    <b>
                      this() 메소드에 인수를 전달하면, 일치하는 생성자를 찾아서
                      호출
                    </b>
                    해 줍니다.
                    <Java_04_04_Code02 />
