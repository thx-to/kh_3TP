...
import Java_04_09_M from "./Java_04_09_M";
        ...
        <Wrap>
          ...
          <Container>
            ...
            <RightContainer>
              <EachClass>
                <ClassHeader>
                  <ClassHeaderTitle>다형성</ClassHeaderTitle>
                </ClassHeader>
                <ClassContentsContainer>
                  <ClassContentsTitle1>다형성이란?</ClassContentsTitle1>
                  <ClassContentsText>
                    객체지향개념에서 다향성이란 한 가지 인터페이스나 클래스를
                    여러 형태로 사용할 수 있는 능력을 가리킵니다. 다형성을 통해
                    코드의 재사용성과 유연성을 높일 수 있습니다.
                    <br />
                    1.{" "}
                    <b>Compile-time Polymorphism (정적 다형성 또는 오버로딩)</b>
                    <br />
                    <ClassContentsTextTab>
                      이는 <b>메서드 오버로딩(Method Overloading)</b>과 관련이
                      있습니다. 같은 이름의 메서드를 여러 개 만들고, 매개변수의
                      타입, 개수, 순서 등을 다르게 정의하여 여러 형태의 메서드를
                      사용할 수 있게 합니다. 컴파일 시에 어떤 메서드가
                      호출되어야 할지 결정됩니다. 정적 다형성은 메서드
                      시그니처(메서드 이름과 매개변수 목록)에 따라서 결정됩니다.
                    </ClassContentsTextTab>
                    2. <b>Runtime Polymorphism (동적 다형성 또는 오버라이딩)</b>
                    <br />
                    <ClassContentsTextTab>
                      이는 <b>메서드 오버라이딩(Method Overriding)</b>과 관련이
                      있습니다. 부모 클래스의 메서드를 하위 클래스에서
                      재정의하여 사용하는 것을 말합니다. 이 경우, 상위 클래스
                      타입의 변수로 하위 클래스의 객체를 참조하더라도 실제로
                      호출되는 메서드는 해당 하위 클래스에서 정의한
                      메서드입니다. 동적 다형성은 런타임에 객체의 실제 타입에
                      따라서 어떤 메서드가 호출되어야 할지 결정됩니다.
                    </ClassContentsTextTab>
                  </ClassContentsText>
                  <br />
                  <ClassContentsTitle2>
                  ...
                  <ClassContentsText>
                    자동 타입 변환은 필드의 값을 대입할 때도 발생하지만, 주로
                    메소드를 호출 할 때 많이 발생 합니다.
                    <br />
                    메소드를 호출 할 때에는 일반적으로는 매개변수의 타입과
                    동일한 매개값을 지정하지만, 상속 관계를 이용해 매개변수에
                    자식 타입의 객체를 사용 할 수 있습니다.{" "}
                    <b>
                      매개변수의 다형성을 이용하면 필요한 시점에 필요한 객체를
                      메소드의 매개 변수로 전달
                    </b>
                    할 수 있습니다.
                  </ClassContentsText>
