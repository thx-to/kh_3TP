...
import Java_04_12_M from "./Java_04_12_M";
            ...
            <RightContainer>
              <EachClass>
                ...
                <ClassContentsContainer>
                  <ClassContentsText>
                    <b>
                      static은 고정된 의미를 가지고 있으며, 정적 멤버는 클래스에
                      고정된 멤버로서 객체를 생성하지 않고 사용 할수 있는 필드와
                      메소드를 의미 합니다.{" "}
                    </b>
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    정적 메소드 내부에서는 인스턴스 필드나 인스턴스 매소드를
                    사용 할 수 없습니다.
                    <br />
                  ...
                  <ClassContentsText>
                    ...
                    <br />- 매개변수에 사용된 final은 전달 받은 매개변수가
                    변경되는 것을 방지하기 위해 사용 됩니다.
                    <Java_04_12_Code02 />
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    final 선언 시 값을 단 한번만 대입할 수 있도 이후로는 변경 할
                    수 없는 상수의 특성을 가집니다.
                    <br />
                    하지만, 자바에서는 final 선언으로만 상수로 부르지 않습니다.
                    <br />
                    왜냐면 변하지 않는 불변의 값은 객체마다 저장 할 필요가 없기
                    때문에 단 한번만 생성되어야 하기 때문입니다.
                    <br />
                    그러므로,{" "}
                    <ClassContentsCode>
