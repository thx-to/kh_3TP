  ...
  return (
    <Wrap>
      ...
      <Container>
        ...
        <ClassContentsText>
          클래스의 기능을 통해 현실세계에 있는 사물을 구현하는 것을 목표로
          합니다.
          <br />
          실제 클래스로 설계할 사물을 기능을 분석하고 이를 필드와 메소드로
          구현해 보겠습니다.
        </ClassContentsText>
        ...
        <ClassContentsText>
          ...
          <br />- 에어컨 ON/OFF 동작을 위해 Scanner 입력에 대한 문자열 체크
          <br />- 현재 온도 표시를 위한 캘린더 API 활용(현재 날짜에 대한 적절한
          온도 설정)
          <Java_04_14_Code01 />
          <Java_04_14_Code02 />
        </ClassContentsText>
        ...
        <ClassContentsText>
          ...
          <br />- 타이머가 설정 되면 설정 온도와 현재 온도가 같아도 계속 동작
          <br />- 타이머 체크 쓰레드를 별도로 만들고 해당 온도가 되면 에어컨
          끄기
        </ClassContentsText>
        <ClassContentsTitle3>3. 기본 에어컨 상속 구현</ClassContentsTitle3>
        <ClassContentsText>
          - Smart Aircon : 온도 설정 및 바람세기 설정 없이 자동으로 동작하게
          하기 (20도 기준)
          <br />- Portable Aircon : 동작 시 1분에 배터리 1%식 줄어 들게 구현
        </ClassContentsText>
        {/* </ClassContentsContainer>
          </EachClass> */}
        <ArrowContainer>
