...
import Java_04_16_M from "./Java_04_16_M";
        ...
        <Wrap>
          ...
          <Container>
            ...
            <RightContainer>
              <EachClass>
                <ClassHeader>
                  <ClassHeaderTitle>Interface</ClassHeaderTitle>
                </ClassHeader>
                <ClassContentsContainer>
                  <ClassContentsTitle2>인터페이스란?</ClassContentsTitle2>
                  <ClassContentsText>
                    자식 클래스가 여러 부모 클래스를 상속받을 수 있다면, 다양한
                    동작을 수행할 수 있다는 장점을 가지게 될 것입니다.
                    <br />
                    하지만 클래스를 이용하여 다중 상속을 할 경우 메소드 출처의
                    모호성 등 여러 가지 문제가 발생할 수 있어{" "}
                    <b>
                    ...
                    <font color="red">
                      <i>
                        인터페이스(interface)란 다른 클래스를 작성할 때 기본이
                        되는 틀을 제공하면서, 다른 클래스 사이의 중간 매개
                        역할까지 담당하는 일종의 추상 클래스
                      </i>
                    </font>
                    를 의미합니다.
                    <ClassContentsImage
                    ...
                    자바에서{" "}
                    <b>
                      추상 클래스는 추상 메소드뿐만 아니라 생성자, 필드, 일반
                      메소드도 포함
                    </b>
                    할 수 있습니다.
                    <br />
                    ...
                    <br />- 상수 : 모든 필드는{" "}
                    <b>자동으로 상수(final static)으로 변환</b>됩니다.
                    <br />- 메소드 : 모든 메소드는 <b>추상 메소드로 변경</b>
                    되며(public abstract 자동으로 추가) 상속 받은 클래스에서
                    구현 해야 함<br />- 디폴트 메소드 : 구현부를 가지고 있으며,
                    <b>상속 받은 클래스에서 재정의 하여 사용 가능</b>합니다.
                    <br />- 정적 메소드 :{" "}
                    <b>객체와 상관없이 인터페이스 타입으로 사용</b>할수
                    있습니다.
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    인터페이스를 선언할 때에는{" "}
                    <b>접근 제어자와 함께 interface 키워드를 사용</b>하면
                    됩니다.
                    <Java_04_16_Code01 />
                    <br />
                    클래스와는 달리 인터페이스의{" "}
                    <b>모든 필드는 public static final</b>이어야 하며,{" "}
                    <b>모든 메소드는 public abstract</b>이어야 합니다. 이 부분은
                    모든 인터페이스에 공통으로 적용되는 부분이므로 부분이므로 이
                    제어자는 생략할 수 있습니다.{" "}
                    <b>생략하면 제어자는 컴파일 시 컴파일러가 자동으로 추가</b>
                    해 줍니다.
                  </ClassContentsText>
                  <br />
                  <ClassContentsTitle2>인터페이스의 구현</ClassContentsTitle2>
                  <ClassContentsText>
                    인터페이스는 추상 클래스와 마찬가지로 자신이 직접 인스턴스를
                    생성 할 수 없습니다.
                    <br />
                    따라서 인터페이스가 포함하고 있는 추상 메소드를 구현해 줄
                    클래스를 작성해야만 합니다.
                    <br />
                    <ClassContentsCode>
                  ...
                  <ClassContentsText>
                    ...
                    <br />
                    - Send와 Rcv는 인터페이스 상속으로 구현해서 CocoTok의 전송
                    기능으로 연결
                    <br />
                    - 전송시 자동으로 네트워크를 찾아주면 좋으나 우선은
                    조건문으로선택해서 연결
                    <br />
                    - 매개변수 다형성을 이용해서 해결
                    <Java_04_16_Code04 />
                  ...
                  <ClassContentsText>
                    클래스는 필드, 생성자, 메소드로 구성되어지는 반면에
                    인터페이스는 상수 필드, 추상메서드로만 구성
                    <br />
                    <br />
