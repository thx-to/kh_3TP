...
import Java_04_17_M from "./Java_04_17_M";
              ...
              <EachClass>
                ...
                <ClassContentsContainer>
                  ...
                  <ClassContentsText>
                    ...
                    합니다.
                    <br />
                    인터페이스에서는 구현부가 있는 메소드를 만들 수 없는 것이
                    기본적인 특징이나 예외적으로 디폴트 메서드를 만들 수
                    있습니다.
                    <br />
                  ...
                  <ClassContentsText>
                    인터페이스에서 디폴트 메소드를 허용한 이유는 기존
                    인터페이스를 확장해서 새로운 기능을 추가하기 위함 입니다.
                    <br />
                    기존 인터페이스의 이름과 추상 메소드의 변경 없이 디폴트
                    메소드만 추가 할 수 있기 때문에 이전에 개발된 구현 클래스를
                    그대로 사용할 수 있으면서 새롭게 개발하는 클래스는 디폴트
                    메소드를 활용할 수 있습니다.
                    <Java_04_17_Code01 />
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    디폴트 메소드는 인터페이스에 선언되지만, 인터페이스에서 사용
                    할 수 없습니다.
                  </ClassContentsText>
