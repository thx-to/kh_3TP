  ...
  return (
    <Wrap>
      ...
      <Container>
        ...
        <hr />
        <ClassContentsText>
          자동차를 상속 받아 승용차, 스포츠카, 버스를 만들고 주어진 설정 정보에
          따라 기능 구현을 하고 결과를 출력하는 문제 입니다.
        </ClassContentsText>
        <br />
        ...
        <ClassContentsText>
          자동차는 스포츠카, 승용차, 버스를 상속 주기 위해 만들어 지며 실제
          객체화 되지 않음
          <br />
          구현해야 할 공통의 메소드는 자동차 클래스에서 구현해서 상속주는 것으로
          구현
          <br />
        ...
        <ClassContentsText>
          ...
          <br />- 속도 : 250km
          <br />- 연료 탱크 크기 : 30리터
          <br />- 좌석수 : 2<br />- 차량이름은 생성자에서 입력 받아서 설정
        ...
        <ClassContentsText>
          ...
          <br />- 부가기능 : 트렁크가 좌석으로 변경 (켜면 승객 1명 추가)
        </ClassContentsText>
        ...
        <ClassContentsText>
          ...
          <br />- 부가기능 : 보조연료탱크(켜면 연료탱크 크기가 30리터 늘어남)
        </ClassContentsText>
        <hr />
        ...
        <ClassContentsText>
          - 이동 지역을 선택하세요 (1. 부산, 2. 대전, 3. 강릉, 4. 광주)
          <br />- 이동할 승객 수를 입력하세요 ( 1 ~ 100 사이)
          <br />- 이동 차량을 선택하세요. (1. 스포츠카, 2. 승용차, 3. 버스)
          <br />- 부가 기능의 ON/OFF 를 선택하세요.
        </ClassContentsText>
        <ClassContentsTitle3>추가 고려 사항</ClassContentsTitle3>
        <ClassContentsText>
          - 입력 값 검증 기능 추가 (이동 지역 및 차량 선택에 대한 잘 못된 입력
          값 검증)
          <br />- 기름값은 고정된 금액이므로 상수 처리
          <br />- 날씨 요인 추가 : 비가 오면 이동 시간 20% 증가, 눈이 오면 이동
          시간 40% 증가, 단, 이동 시간이 증가해도 연비와 비용은 거리와 횟수와
          관련이 있으므로 비용은 증가하지 않음
        </ClassContentsText>
        <br />
