...
import Java_04_21_M from "./Java_04_21_M";
        ...
        <Wrap>
          ...
          <Container>
            ...
            <RightContainer>
              <EachClass>
                <ClassHeader>
                  <ClassHeaderTitle>다중 인터페이스와 상속</ClassHeaderTitle>
                </ClassHeader>
                <ClassContentsContainer>
                  <ClassContentsTitle2>
                    다중 인터페이스를 사용하는 이유
                  ...
                  <ClassContentsText>
                    ...
                    <br />
                    <ClassContentsTextTab>
                      클래스가 다중 인터페이스를 구현하면 다양한 인터페이스의
                      기능을 사용할 수 있으므로, 더 유연하고 재사용 가능한
                      코드를 설계할 수 있습니다.
                    </ClassContentsTextTab>
                    2. <b>인터페이스의 다중 상속</b>
                    <br />
                    <ClassContentsTextTab>
                      클래스가 여러 인터페이스를 구현함으로써, 인터페이스의 다중
                      상속을 흉내낼 수 있습니다. 이는 클래스가 여러 기능을
                      동시에 수행하거나 여러 종류의 동작을 지원할 수 있도록
                      합니다.
                    </ClassContentsTextTab>
                    3. <b>코드 간 결합도 감소</b>
                    <br />
                    <ClassContentsTextTab>
                      클래스가 여러 인터페이스를 구현하는 경우, 해당
                      인터페이스들 간에는 직접적인 의존성이 없으므로 클래스 간의
                      결합도가 낮아집니다. 이는 유지보수성과 확장성을
                      향상시키는데 도움이 됩니다.
                    </ClassContentsTextTab>
                    4. <b>다형성과 다중 인터페이스 활용</b>
                    <br />
                    <ClassContentsTextTab>
                      클래스가 다중 인터페이스를 구현하면, 해당 클래스의
                      인스턴스는 각 인터페이스의 다형성을 활용하여 다양한
                      상황에서 사용될 수 있습니다.
                    </ClassContentsTextTab>
                    5. <b>기능 분리와 명확성</b>
                    <br />
                    <ClassContentsTextTab>
                      각 인터페이스는 특정한 기능이나 역할을 나타내므로,
                      클래스가 다중 인터페이스를 구현하면 기능들을 더욱 분리하여
                      코드를 더 명확하게 구조화할 수 있습니다.
                    </ClassContentsTextTab>
                    6. <b>좋은 설계의 향상</b>
                    <br />
                    <ClassContentsTextTab>
                      인터페이스를 사용하여 클래스의 기능을 구성하는 것은 좋은
                      객체 지향 설계의 원칙을 따르는데 도움이 됩니다. 각
                      인터페이스는 단일 책임 원칙을 따르며, 이는 코드를 더욱
                      모듈화하고 이해하기 쉽게 만들어줍니다.
                    </ClassContentsTextTab>
                    <br />
                    요약하면, 다중 인터페이스를 사용하는 것은 유연한 설계,
                    재사용성, 다형성, 결합도 감소 등 다양한 이점을 제공하여 좋은
                    객체 지향 프로그래밍과 좋은 소프트웨어 설계를 지원합니다.
                  </ClassContentsText>
                  <br />
                  <ClassContentsTitle2>
                    인터페이스와 클래스 설계 예시
                  ...
                  <ClassContentsText>
                    한 클래스가 여러 클래스로 부터 상속을 받으면 여러 가지
                    문제가 발생 할 수 있습니다.
                    <br />
                    자바는 이런 문제를 해결하기 위해 한 클래스가 여러
                    인터페이스를 구현 할 수 있습니다.
                    <Java_04_21_Code06 />
                    <Java_04_21_Code07 />
                    <Java_04_21_Code08 />
                  ...
                  <ClassContentsText>
                    ...
                    <br />
                    Customer 클래스가 Buy, Sell 두 인터페이스를 구현하고 Buy
                    인터페이스와 Sell 인터페이스에 똑같은 디폴트 order()
                    메소드를 가지는 경우 문제가 됩니다.
                    <br />이 경우 상속받는 Customer 클래스에서{" "}
                    <b>재정의해서 사용</b>해야 합니다. (명시적인 메소드 재정의)
                    <br />- 컴파일 타임에서는 문제가 발생하지 않지만 런타임에서
                    문제를 야기 할 수 있습니다.
                    <Java_04_21_Code10 />
                    <Java_04_21_Code11 />
                    <Java_04_21_Code12 />
