    ...
    <Wrap>
      ...
      <Container>
        ...
        <ClassContentsText>
          ...
          <b>
            중첩 클래스는 크게 정적 중첩 클래스(Static Nested Class)와 내부
            클래스(Inner Class)
          </b>
          로 나뉩니다.
        </ClassContentsText>
        ...
        <ClassContentsText>
          - 외부 클래스와의 강한 연관이 필요하지 않을 때 사용. 특히, 외부
          클래스의 인스턴스와 상관없이 동작하는 클래스를 정의할 때 많이 사용
          <br />- 복잡한 클래스 구조에서 외부 클래스와 논리적으로 강하게 묶여
          있는 하위 클래스를 그룹화하는데 유용
          <Java_04_23_Code01 />
        </ClassContentsText>
        <br />
        <ClassContentsTitle2>인스턴스 내부 클래스</ClassContentsTitle2>
        <ClassContentsText>
          인스턴스 내부 클래스는 인스턴스 변수를 선언할 때와 같은 위치에
          선언하며, 외부 클래스 내부에서만 생성하여 사용하는 객체를 선언할 때
          씁니다.
          <br />- 외부 클래스의 인스턴스가 생성되어야만 접근할 수 있는 내부
          클래스입니다.
          <br />- 외부 클래스의 인스턴스 멤버(필드, 메서드)에 직접적으로 접근할
          수 있습니다.
          <br />- 외부 클래스의 멤버와 내부 클래스의 멤버들 간의 서로 private
          멤버도 접근이 가능합니다.
          <br />- 내부 클래스의 인스턴스를 생성할려면 외부 클래스의 인스턴스를
          먼저 생성해야 합니다.
          <Java_04_23_Code02 />
          <Java_04_23_Code03 />
        </ClassContentsText>
        ...
        <ClassContentsText>
          ...
          <br />
          <b>
            중첩 인터페이스는 주로 UI 프로그래밍에서 이벤트를 처리할 목적으로
            활용
          </b>
          됩니다.
          <br />
          인터페이스를 클래스 내부에 선언하는 이유는 해당 클래스와 긴밀한 관계를
          맺는 구현 클래스를 만들기 위해서 입니다.
          <br />
          Button을 클릭 했을 때, 이벤트를 처리하는 객체를 받고 싶은 경우, Button
          내부에 선언된 중첩 인터페이스를 구현한 객체만 받아야 한다면 다음과
          같이 Button 클래스를 선언하면 됩니다.
        </ClassContentsText>
        <b>Button.java</b>
        <Java_04_23_Code04 />
        <br />
