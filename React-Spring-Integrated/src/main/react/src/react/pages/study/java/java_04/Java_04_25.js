...
import Java_04_25_M from "./Java_04_25_M";
              ...
              <EachClass>
                ...
                <ClassContentsContainer>
                  ...
                  <ClassContentsText>
                    ...
                    <b>
                      컴파일 과정과 실행과정에에서 코드를 어떻게 컴파일하고 처리
                      할 것인지 알려 주는 정보
                    </b>
                    입니다.
                    <br />
                    <ClassContentsCode>@AnnotationName</ClassContentsCode>
                    <br />- 컴파일러에게 코드 문법의 에러를 체크하도록 정보를
                    제공
                    <br />- 소프트웨어 개발 툴이 빌드나 배치 시 코드를 자동으로
                    생성 할 수 있도록 정보를 제공
                  ...
                  <ClassContentsText>
                    - 표준(내장)어노테이션 : 자바가 기본적으로 제공해주는
                    어노테이션
                    <br />- 메타 어노테이션 : 어노테이션을 위한 어노테이션
                    <br />- 사용자정의 어노테이션 : 사용자가 직접 정의하는
                    어노테이션
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    함수형 인터페이스에 붙이면, 컴파일러가 올바르게 작성 했는지
                    체크
                    <br />
                    해당 어노테이션은, 함수형 인터페이스의 "하나의 추상메서드만
                    가져야 한다는 제약"을 확인해준다.
                    <br />
