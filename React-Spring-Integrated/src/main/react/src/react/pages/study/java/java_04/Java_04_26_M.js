    ...
    <Wrap>
      ...
      <TopBoxWide2>
        <TopBox2>
          ...
          <TopBoxText2 onClick={() => handleRefresh()}>26. Package</TopBoxText2>
        </TopBox2>
      </TopBoxWide2>
      <Container>
        {/* <EachClass>
        ...
        <ClassContentsText>
          ...
          <br />
          클래스와 인터페이스를 함께 묶음으로 파일을 효율적으로 관리 할 수
          있습니다.
          <br />
          협업 시 서로 작업한 클래스 사이에서 발생 할 수 있는 이름의 충돌 문제도
          패키지를 사용하면 피할 수 있습니다.
          <br />- 자바에서 패키지는 <b>물리적으로 하나의 디렉토리를 의미</b>
          합니다.
          <br />-{" "}
          <b>클래스 이름이 동일하더라도 패키지가 다르면 다른 클래스 인식</b>
          합니다.
          <br />- 상위패키지.하위패키지.클래스
          <br />
        ...
        <ClassContentsText>
          ...
          <br />- 숫자로 시작하면 안되고 특수문자는 _와 $만 사용 가능 합니다.
          (한글 가능 합니다.)
        ...
        <ClassContentsText>
          패키지를 사용하면 비슷한 성격의 클래스들끼리 묶을 수 있어 클래스의
          분류가 용이하다. 그리고 자바코드를 작성하다 보면 다른 사람이 작성한
          자바 클래스나 라이브러리를 사용해야 할 경우도 많이 생기는데 이 때
          클래스명이 동일한 경우도 발생할 수 있을 것이다. 하지만{" "}
          <b>패키지명이 다르면 클래스명이 동일해도 충돌없이 사용할 수 있다.</b>{" "}
          따라서 배포용으로 작성하는 자바 클래스는 반드시 패키지명을 포함하는
          것이 올바른 방법이다.
          <br />
        ...
        <ClassContentsText>
          사용하고자 하는 클래스 또는 인터페이스가 다른 패키지에 소속되어
          있다면, import문으로 해당 패키지의 클래스 또는 인터페이스를 가져와
          사용할 것을 컴파일러에게 알려 줘야 합니다.
          <Java_04_26_Code02 />
          <Java_04_26_Code03 />
          <Java_04_26_Code04 />
          <Java_04_26_Code05 />
