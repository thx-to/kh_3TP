...
import Java_05_01_M from "./Java_05_01_M";
              ...
              <EachClass>
                ...
                <ClassContentsContainer>
                  ...
                  <ClassContentsText>
                    ...
                    <br />
                    JDK에서 제공하는 많은 클래스를 활용하면 프로그램을 더욱
                    효율적으로 구현 할 수 있습니다.
                    <br />
                    현재 강의에서 사용하는 버전은 JDK 11 입니다. 서점이나
                    강의에서 사용되는 대부분의 버전이 JDK 8이며 이후의
                    문법적으로 변화는 크지 않습니다. 우리가 JDK 11 사용하는
                    이유는 현재 현업에서 백앤드(Spring) 개발 시 가장 많이
                    사용되는 버전이기 때문 입니다.
                    <br />
                    <ClassLinkBox
                  ...
                  <ClassContentsText>
                    ...
                    입니다.
                    <br />
                    따라서 자바에서는 java.lang 패키지의 클래스들은 import 문을
                    사용하지 않아도 클래스 이름만으로 바로 사용할 수 있도록 하고
                    있습니다. (컴파일 시{" "}
                    <ClassContentsCode>import java.lang.*</ClassContentsCode> 이
                    자동 추가 됩니다.)
                  </ClassContentsText>
                  <ClassTableBox>
                    <ClassTable>
                      ...
                      <ClassTableTr>
                        ...
                        <ClassTableTd>
                          표준 입출력 장치로 부터 데이터를 입력 받거나 출력 할
                          때 사용, 자바의 JVM을 종료 시킬 때 사용, 쓰레기
                          수집기를 실행 요청 할 때 사용
                        </ClassTableTd>
                      </ClassTableTr>
                      <ClassTableTr>
