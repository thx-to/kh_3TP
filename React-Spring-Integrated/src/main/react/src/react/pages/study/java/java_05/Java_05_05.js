...
import Java_05_05_M from "./Java_05_05_M";
        ...
        <Wrap>
          ...
          <Container>
            ...
            <RightContainer>
              <EachClass>
                <ClassHeader>
                  <ClassHeaderTitle>Enum 클래스</ClassHeaderTitle>
                </ClassHeader>
                <ClassContentsContainer>
                  ...
                  <ClassContentsText>
                    ...
                    <br />-{" "}
                    <b>열거체를 비교 할 때 실제 값뿐만 아니라 타입까지 체크</b>
                    합니다.
                    <br />- 기존의 public class 내에 final static 으로 정의 하던
                    부분에 대한 대체
                    <br />
                  ...
                  <ClassContentsText>
                    열거 타입을 선언 했다면 타입을 사용 할 수 있습니다. 열거
                    타입도 하나의 데이터 타입이므로 변수를 선언하고 사용해야
                    합니다.
                    <br />
                    ...
                    <br />
                    열거 타입 변수를 선언 했다면 아래와 같이 열거 상수를 저장 할
                    수 있습니다. 열거 상수는 단독으로 사용할 수 없고 반드시 열거
                    타입.열거상수로 사용 됩니다.
                    <br />
                    <ClassContentsCode>
                      열거타입 변수 = 열거타입.열거상수;
                  ...
                  <ClassContentsText>
                    ordinal() 메소드는{" "}
                    <b>
                      해당 열거체 상수가 열거체 정의에서 정의된 순서(0부터
                      시작)를 반환
                    </b>
                    합니다.
                    <br />
                    이때 반환되는 값은 열거체 정의에서 해당 열거체 상수가 정의된
                    순서이며, 상수값 자체가 아님을 명심해야 합니다.
                    <Java_05_05_Code05 />
                  </ClassContentsText>
                  <ClassContentsTitle3>
                    열거체의 상수값 정의 및 추가
                  ...
                  <ClassContentsText>
                    열거체의 기본적으로 첫 번째 상수값은 0부터 설정되며, 그 다음
                    상수값은 1만큼 증가되면서 자동 설정 됩니다.
                    <br />
