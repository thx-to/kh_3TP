...
import Java_05_07_M from "./Java_05_07_M";
            ...
            <RightContainer>
              <EachClass>
                ...
                <ClassContentsContainer>
                  <ClassContentsText>
                    프로그램에 따라{" "}
                    <b>기본 타입의 데이터를 객체로 취급해야 하는 경우</b>가
                    있습니다. (제네릭, 컬렉션 프레임워크)
                    <br />
                    예를 들어, 메소드의 인수로 객체 타입만이 요구되면, 기본
                    타입의 데이터를 그대로 사용할 수는 없습니다.
                    <br />
                    이때에는 기본 타입의 데이터를 먼저 객체로 변환한 후 작업을
                    수행해야 합니다.
                    <br />
                    이렇게{" "}
                    <b>
                      8개의 기본 타입에 해당하는 데이터를 객체로 포장해 주는
                      클래스를 래퍼 클래스(Wrapper class)
                    </b>
                    라고 합니다.
                    <br />
                    래퍼 클래스는 각각의 타입에 해당하는 데이터를 인수로
                    전달받아, 해당 값을 가지는 객체로 만들어 줍니다.
                    <br />
                    이러한 래퍼 클래스는 모두 java.lang 패키지에 포함되어
                    제공됩니다.
                    <ClassTableBox>
                  ...
                  <ClassContentsText>
                    래퍼 클래스(Wrapper class)는 산술 연산을 위해 정의된
                    클래스가 아니므로, 인스턴스에 저장된 값을 변경할 수
                    없습니다.
                    <br />
                    단지, 값을 참조하기 위해 새로운 인스턴스를 생성하고, 생성된
                    인스턴스의 값만을 참조할 수 있습니다.
                    <ClassContentsImage
                      style={{
                        width: "100%",
                        height: "400px",
                  ...
                  <ClassContentsText>
                    JDK 1.5부터는 박싱과 언박싱이 필요한 상황에서 자바
                    컴파일러가 이를 자동으로 처리해 줍니다.
                    <br />
