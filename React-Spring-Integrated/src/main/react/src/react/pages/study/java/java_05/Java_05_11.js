...
import Java_05_11_M from "./Java_05_11_M";
          ...
          <Container>
            ...
            <RightContainer>
              <EachClass>
                ...
                <ClassContentsContainer>
                  <ClassContentsText>
                    자바의 모든 클래스와 인터페이스는 컴파일되고 나면 class
                    파일로 생성됩니다.
                    <br />
                    class 파일에는 클래스나 인터페이스에 대한 변수, 메소드,
                    생성자 등의 정보가 들어 있습니다.
                  </ClassContentsText>
                  <br />
                  <ClassContentsTitle2>Class 클래스란?</ClassContentsTitle2>
                  <ClassContentsText>
                    Class 클래스는 컴파일된 class 파일에 저장된 클래스나
                    인터페이스 정보를 가져오는데 사용 합니다.
                    <br />
                    예를 들어, 모르는 클래스의 정보를 사용할 경우 직접 클래스의
                    정보를 찾아야 하는데 이때 Class 클래스를 활용하면 됩니다.
                    <br />
                    <b>
                      Class 클래스를 선언하고 클래스 정보를 가져오는 방법은
                      아래의 세 가지 방법이 있습니다.
                    </b>
                  </ClassContentsText>
                  <ClassContentsTitle3>
