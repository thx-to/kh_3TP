    ...
    <Wrap>
      ...
      <TopBoxWide2>
        <TopBox2>
          ...
          <TopBoxText2 onClick={() => handleRefresh()}>01. 제네릭</TopBoxText2>
        </TopBox2>
      </TopBoxWide2>
      <Container>
        {/* <EachClass>
        ...
        <ClassContentsText>
          <font color="red">
            ...
            일반화한다(generalize)는 것을 의미합니다. (데이터 형식에 의존하지
            않고, 하나의 값이 여러 다른 데이터 타입을 가질 수 있도록 하는 방법)
          </font>
          <br />
          <br />
          이렇게 함으로써 여러가지{" "}
          <b>데이터 타입 또는 자료구조에 상관없이 동일한 프로그래밍이 가능</b>
          합니다.
          <br />
          프로그램에서 변수를 선언 할 때 모든 변수는 자료형이 있습니다.
          메소드에서 매개변수를 사용하는 경우에도 자료형을 가지고 있습니다.
          일반적인 경우에는 하나의 자료형으로 구현을 하지만, 변수나 메소드의
          자료형을 필요에 따라 여러 자료형으로 바꿀 수 있다면 프로그램이 훨씬
          유연해 집니다. 이와 같이 어떤 값이 참조하는 자료형이 아닌 여러
          참조형을 사용할 수 있도록 프로그래밍하는 것을{" "}
          <font color="red">
            <b>제네릭 프로그래밍</b>
          </font>
          이라고 합니다.
          ...
          <br />
          이렇게 컴파일 시에 미리 타입 검사(type check)를 수행하면 다음과 같은
          장점을 가집니다.
          <br />
        ...
        <ClassContentsTitle2>제네릭의 선언 및 생성</ClassContentsTitle2>
        <ClassContentsText>
          자바에서 제네릭은 클래스와 메소드에만 다음과 같은 방법으로 선언 할 수
          있습니다.
          <Java_06_01_Code03 />
          위의 예제에서 사용된{" "}
          <b>
          ...
          합니다.
          <br />꼭 'T'뿐만 아니라 어떠한 문자를 사용해도 상관없으며, 여러 개의
          타입 변수는 쉼표(,)로 구분하여 명시할 수 있습니다.
          <br />
          <b>
            타입 변수는 클래스에서뿐만 아니라 메소드의 매개변수나 반환값으로도
            사용
          </b>
          할 수 있습니다.
          <br />
          위와 같이 선언된 제네릭 클래스(generic class)를 생성할 때에는 타입
          변수 자리에 사용할 실제 타입을 명시해야 합니다.
        </ClassContentsText>
        <br />
        ...
        <Java_06_01_Code05 />
        <br />
        <ClassContentsTitle2>제네릭 클래스 사용 예제</ClassContentsTitle2>
        <Java_06_01_Code06 />
        <Java_06_01_Code07 />
        <Java_06_01_Code08 />
        <Java_06_01_Code09 />
        ...
        <ClassContentsText>
          제네릭 클래스에서 T 자료형에 사용할 자료형에 대해 제한을 걸어야 할
          경우가 있습니다. 예를 들어 위의 예제와 같이 프린터를 위해 다양한
          재료를 사용할 수 있는데 사용 할 수 없는 재료가 있을 수 있습니다.
          <br />
          <ClassContentsCode>
            {`GenericPrinter<Water> plasticPrinter = new GenericPrinter<>();`}
          </ClassContentsCode>
          <br />
          이런 일을 방지 하기 위해 상속 관계를 이용해 제한을 걸 수 있습니다.
          <ClassContentsImage
            style={{
              width: "100%",
              height: "180px",
