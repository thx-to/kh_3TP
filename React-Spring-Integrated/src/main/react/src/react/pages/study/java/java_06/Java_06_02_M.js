  ...
  return (
    <Wrap>
      ...
      <Container>
        ...
        <ClassContentsText>
          자바는 배열의 여러가지 문제점을 해결하고 , 알려진 자료 구조를 바탕으로
          객체를 효율적으로 추가, 삭제, 검색 할 수 있도록 java.util 패키지에{" "}
          ...
          <b>
            <font color="red">
              데이터를 저장하는 자료 구조와 데이터를 처리하는 알고리즘을
              구조화하여 클래스로 구현해 놓은 것
            </font>
            입니다.
            <br />
            이러한 컬렉션 프레임워크는 자바의 인터페이스(interface)를 사용하여
            구현됩니다.
            <br />
            <font color="red">
            ...
            <i>
              {" "}
              패키지에 포함되어 있습니다. (자바에서 두번째 많이 사용되는 패키지
              입니다.)
            </i>
          </b>
        </ClassContentsText>
          ...
          <ClassTableBox>
            <ClassTable style={{ textAlign: "center" }}>
              ...
              <ClassTableTr>
                ...
                <ClassTableTd>
                  키와 값의 한쌍으로 이루어지는 데이터의 집합으로 순서가 없음.
        ...
        <ClassContentsText>
          <b>
            컬렉션 프레임워크에 속하는 인터페이스를 구현한 클래스를 컬렉션
            클래스
          </b>
          라고 합니다.
          <br />
          ...
          하고 있습니다.
          <br />
          Vector나 Hashtable과 같은 컬렉션 클래스는 예전부터 사용해 왔으므로,
          기존 코드와의 호환을 위해 아직도 남아 있습니다.
          <br />
          하지만 기존에 사용하던 컬렉션 클래스를 사용하는 것보다는 새로 추가된{" "}
          <b>ArrayList나 HashMap 클래스</b>를 사용하는 것이 성능 면에서도 더
          나은 결과를 얻을 수 있습니다.
          <ClassContentsImage
            style={{
              width: "100%",
        ...
        <ClassContentsText>
          Collection 인터페이스 하위에 List 인터페이스와 Set 인터페이스가
          있습니다.
          <br />
          List를 구현한 클래스는 순차적인 자료를 관리하는데 사용하는 클래스이고,
        ...
        <ClassContentsText>
          Map 인터페이스는 하나가 아닌 쌍으로 되어 있는 자료를 관리하는
          메서드들이 선언되어 있습니다.
          <ClassContentsImage
            style={{
              width: "100%",
