    ...
    <Wrap>
      ...
      <TopBoxWide2>
        <TopBox2>
          ...
          <TopBoxText2 onClick={() => handleRefresh()}>04. Map</TopBoxText2>
        </TopBox2>
      </TopBoxWide2>
      <Container>
        {/* <EachClass>
        ...
        <ClassContentsText>
          ...
          되어 있습니다.
          <br />
          하나의 <b>쌍(Pair)는 키(key)와 값(value)</b>으로 이루어져 있습니다.
          <br />
        ...
        <ClassContentsText>
          데이터에 대한 검색과 저장에서 아주 우수한 성능을 보여 쓰임새가
          많습니다.
          <br />
          Hash로 값을 생성하면 고유 주소 값이 생기는데 이것을 숫자로 변환한 것을{" "}
          <b>해시코드</b>라고 합니다.
          <br />
          즉, 자바에서 <b>해시코드는 Heap 영역에 인스턴스에 대한 참조 값</b>
          이라고도 부를 수 있습니다.
          <br />
          <b>Hash 함수</b>란? 데이터의 효율적인 관리를 위해 임의의 길이를 가진
          데이터를 고정된 길이를 가진 테이터로 매핑해주는 함수 입니다. (암호화
          기법이라고도 볼 수 있습니다.
        </ClassContentsText>
        <ClassContentsTitle3>Hash Collision?</ClassContentsTitle3>
        <ClassContentsText>
          가장 이상적인 해시테이블은 한 버켓에 딱 한개의 노드가 있는 경우
          입니다. 이 경우 데이터 검색의 경우 인덱스만 계산하면 바로 값을 찾을 수
          있으므로 <b>O(1)의 시간복잡도를 보장</b>할 수 있습니다. 이 경우를
          제외하고 한 버켓에 여러개의 노드가 있는 경우를 충돌이라고 합니다.
        </ClassContentsText>
        <br />
        <ClassContentsTitle2>Map 컬렉션</ClassContentsTitle2>
        <ClassContentsText>
          Map은 리스트나 배열처럼 순차적으로(sequential) 해당 요소 값을 구하지
          않고 key를 통해 value를 얻는다. 맵(Map)의 가장 큰 특징이라면{" "}
          <b>key로 value를 얻어낸다는 점</b>이다.
          <br />- 순서가 보장 되지 않음 (HashMap)
          <br />- 키와 값으로 구성되어 있으며{" "}
          <b>키는 중복 허용하지 않고 값은 중복 가능</b>
          <br />- HashMap, HashTable, TreeMap, Properties
          <br />- 키의 동일 조건은 hashCode()의 리턴값이 같고, equals()메소드의
          결과가 true
          <ClassContentsImage
            style={{
              width: "100%",
        ...
        <ClassContentsText>
          키의 해시 값을 계산하여 저장하고 검색 속도를 빠르게 합니다. 순서를
          보장하지 않습니다.
          <br />
          HashMap은 Map 인터페이스를 구현한 대표적인 Map 컬렉션 입니다. (가장
          많이 사용 됨)
          <br />
          haseCode() 리턴값과 equals()리턴값이 같은 경우 같은 키로 간주 합니다.
          <ClassContentsImage
            style={{
              width: "100%",
              height: "80px",
          ...
          <ClassTableBox>
            <ClassTable style={{ textAlign: "center" }}>
              ...
              <ClassTableTr>
                ...
                <ClassTableTd>
                  지정된 키에 해당하는 값을 반환합니다. 키가 없으면 null을
                  반환합니다.
                </ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
              ...
              <ClassTableTr>
                ...
                <ClassTableTd>맵에 모든 항목을 제거하여 비웁니다.</ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
              ...
              <ClassTableTr>
                ...
                <ClassTableTd>
                  맵에 있는 모든 값을 포함하는 Collection을 반환합니다.
                </ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
                <ClassTableTd>entrySet()</ClassTableTd>
                <ClassTableTd>
                  맵에 있는 모든 키-값 쌍을 포함하는 Set 컬렉션을 반환합니다.
                </ClassTableTd>
              </ClassTableTr>
            </ClassTable>
          </ClassTableBox>
        </ClassContentsText>
        <ClassContentsTitle3>기본 예제 (기본 문법 익히기)</ClassContentsTitle3>
        <Java_06_04_Code02 />
        <ClassContentsTitle3>
        ...
        <ClassContentsText>
          ...
          <br />- HashTable도 키로 사용할 객체는 hashCode()와 equals() 메소드를
        ...
        <ClassContentsText>
          ...
          <br />- 내부 설정 정보 읽기(database.properties가 생성되어 있지 않으면
          에러 발생)
