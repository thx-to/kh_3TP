  ...
  return (
    <Wrap>
      ...
      <Container>
        ...
        <ClassContentsText>
          <b>
            순서와 상관없이 중복을 허용하지 않는 경우에는 Set 인터페이스를
            구현한 클래스를 사용
          </b>
          합니다.
        </ClassContentsText>
        ...
        <ClassContentsText>
          - 요소의 순서를 유지 하지 않음
          <br />- 요소의 중복 허용하지 않음 (hashCode() 리턴값을 사용하여 객체가
          동일한지 판단 합니다.)
          <br />- 수학의 집합과 유사한 개념
        ...
        <ClassContentsText>
          기본적으로 <b>인스턴스 주소가 같으면 같은 객체</b>입니다. 하지만
          아래의 예제에서는 회원 아이디가 같으면 같은 회원으로 볼 수 있습니다.
          이런 경우 Object 클래스의 hashCode()와 equals()를 오버라이드 해서 사용
          할 수 있습니다.
          <ClassContentsCodeBox>
            👉 모든 클래스는 Object의 매서드를 사용할 수 있고, 필요에 따라
            재정의해서 사용 할 수 있습니다. 하지만 Object의 모든 메소드를
            재정의해서 사용할 수 있는 것은 아닙니다. (final로 선언된 메소드는
            재정의 할 수 없습니다.)
          </ClassContentsCodeBox>
          <Java_06_05_Code03 />
        </ClassContentsText>
        ...
        <ClassContentsText>
          ...
          <br />- LinkedHashSet : 입력한 순서대로 값을 정렬하여 저장하는 특징이
          있다.
        </ClassContentsText>
        <ClassContentsTitle2>
