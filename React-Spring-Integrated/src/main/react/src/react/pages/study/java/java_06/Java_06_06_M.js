  ...
  return (
    <Wrap>
      ...
      <Container>
        ...
        {/* <ClassContentsContainer> */}
        <ClassContentsText>
          컬렉션 프레임워크는 <b>검색 기능을 강화</b>시킨 TreeSet와 TreeMap을
          제공하고 있습니다.
        </ClassContentsText>
        <br />
        <ClassContentsTitle2>{`TreeSet<E>클래스`}</ClassContentsTitle2>
        <ClassContentsText>
          - TreeSet 클래스는 데이터가 정렬된 상태로 저장되는{" "}
          <b>이진 검색 트리(binary search tree)의 형태로 요소를 저장</b>
          합니다.
          <br />- 요소들이 자동으로 정렬이 됩니다. 특정 기준으로 정렬이 필요하면
          Comparator를 사용
          <br />- 삽입, 삭제, 검색시 O(log n)의 시간 복잡도를 가짐
          <br />- 중복 허용하지 않음
          <br />- 요소들이 정렬된 상태로 유지되어야 할 때 사용 (사용자 정의
          기준에 따라 정렬된 데이터가 필요할 때 사용)
        </ClassContentsText>
        ...
        <ClassContentsText>
          ...
          />
          이진 검색 트리는 데이터를 추가하거나 제거하는 등의 기본 동작 시간이
          매우 빠릅니다.
          <br />
          좌, 우 child 노드를 참조하기 위한 두 개의 변수로 구성되어 있습니다.
        </ClassContentsText>
        <ClassContentsTitle3>간단한 검색 트리 예제</ClassContentsTitle3>
        <ClassContentsText>
          <ClassContentsCodeBox>
            💡 23, 10, 48, 15, 7, 22, 56
          </ClassContentsCodeBox>
          ...
          <b>중위(Inorder) 순회를 하면 오름차순된 결과값</b>을 얻을 수 있습니다.
          (Left - Root - Right)
          <ClassContentsCodeBox>
            💡 7 → 10 → 15 → 22 → 23 → 48 → 56
          </ClassContentsCodeBox>
        ...
        <ClassContentsText>
          <ClassTableBox>
            <ClassTable style={{ textAlign: "center" }}>
              ...
              <ClassTableTr>
                <ClassTableTd rowspan="4">특정 객체 검색</ClassTableTd>
                <ClassTableTd>Object first()</ClassTableTd>
                <ClassTableTd>정렬된 순서에서 첫 번째 객체 반환</ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
                <ClassTableTd>Object last()</ClassTableTd>
                <ClassTableTd>정렬된 순서에서 마지막 객체 반환</ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
                <ClassTableTd>Object lower(Object o)</ClassTableTd>
                <ClassTableTd>
                  지정된 객체보다 작은 값을 가진 객체 중 제일 가까운 객체 반환,
                  없으면 null
                </ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
                ...
                <ClassTableTd>
                  지정된 객체보다 큰 값을 가진 객체 중 제일 가까운 값의 객체
                  반환, 없으면 null
                </ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
                <ClassTableTd>정렬</ClassTableTd>
                <ClassTableTd>NaviableSet descendingSet()</ClassTableTd>
                <ClassTableTd>
              ...
              <ClassTableTr>
                ...
                <ClassTableTd>SortedSet headSet(Object toElement)</ClassTableTd>
                <ClassTableTd>지정된 객체보다 작은 값의 객체 반환</ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
                <ClassTableTd>SortedSet tailSet(Object toElement)</ClassTableTd>
                <ClassTableTd>
              ...
              <ClassTableTr>
                <ClassTableTd>
                  SortedSet subSet(Object frontElement, Object toElement)
                </ClassTableTd>
                <ClassTableTd>
        ...
        <ClassContentsText>
          ...
          <br />- TreeSet에 성적을 추가하여 합격점수와 불합격 점수 출력( 합격
          기준은 60점)
          <Java_06_06_Code02 />
        </ClassContentsText>
        <br />
        ...
        <ClassContentsText>
          Map 인터페이스를 구현한 클래스 중 key 값으로 자료를 정렬하려면
          TreeMap을 사용 할 수 있습니다.
          <br />
          TreeMap은 TreeSet과 마찬가지로 이진 검색 트리로 구현 되어 있습니다.
          <br />
          Key 값으로 정렬하므로{" "}
          <b>key 값에 해당하는 클래스에 Comparable과 Comparator를 구현</b>
          해야 합니다.
          <br />- 이진 트리 기반의 Map 컬렉션 입니다.
          <br />- TreeSet과 차이점은 키와 값이 저장된 Map.Entry를 저장 합니다.
          <br />- 기본적으로 부모키값과 비교해 낮은것은 왼쪽에 높은 것으로
          오른쪽에 저장 합니다.
          <ClassContentsImage
            style={{
              width: "100%",
          ...
          />
          - Map 인터페이스 타입 변수에 대입해도 되지만 TreeMap 클래스 타입으로
          대입하는 이유는 특정 객체를 찾거나 범위 검색과 관련된 메소드를
          사용하기 위함 입니다.
          <br />
          <ClassContentsCode>
          ...
          <ClassTableBox>
            <ClassTable style={{ textAlign: "center" }}>
              ...
              <ClassTableTr>
                ...
                <ClassTableTd>제일 낮은 Map.Entry를 리턴</ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
                <ClassTableTd>lastEntry()</ClassTableTd>
                <ClassTableTd>제일 높은 Map.Entry를 리턴</ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
              ...
              <ClassTableTr>
                ...
                <ClassTableTd>
                  주어진 키와 동등한 키가 있으면 해당 Map.Entry를 리턴, 없다면
                  주어진 키 바로 아래의 Map.Entry 리턴
                </ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
        ...
        <ClassContentsTitle2>내림차순으로 출력하기</ClassContentsTitle2>
        <ClassContentsText>
          <ClassTableBox>
            <ClassTable style={{ textAlign: "center" }}>
              <ClassTableTr>
          ...
          사용하면 되는데 entrySet() 메서드는 key와 value의 값이 모두 필요한
          경우 사용하고, keySet() 메서드는 key의 값만 필요한 경우 사용합니다.
        </ClassContentsText>
