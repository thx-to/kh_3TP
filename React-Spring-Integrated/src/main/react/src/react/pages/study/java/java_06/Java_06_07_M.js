  ...
  return (
    <Wrap>
      ...
      <Container>
        ...
        <ClassContentsText>
          <b>
            Comparable과 Comparator는 자바에서 객체들을 정렬하는 데 사용되는
            인터페이스입니다. 이 둘은 객체 비교와 정렬에 있어서 서로 다른 접근
            방식을 제공합니다.
          </b>
        </ClassContentsText>
        <br />
        ...
        <ClassContentsText>
          ...
          <br />
          <b>
            자바에서 같은 타입의 인스턴스를 서로 비교해야만 하는 클래스들은 모두
        ...
        <ClassContentsText>
          Comparator 역시 정렬을 구현하는 사용하는 인터페이스 입니다. Comparator
          인터페이스는 compare()메소드를 구현해야 합니다.
