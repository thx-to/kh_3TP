  ...
  return (
    <Wrap>
      ...
      <Container>
        ...
        <ClassContentsText>
          LIFO(Last in First Out) 구조 입니다. 스택을 응용한 대표적인 예가 JVM의
          스택 메모리 입니다.
          <br />
        ...
        <ClassContentsText>
          ...
          <br />
          자바에서 큐는{" "}
          <b>LinkedList를 활용하여 생성해야 하므로 LinkedList가 import</b>
          되어야 합니다.
          <ClassContentsImage
            style={{
              width: "100%",
            ...
            <ClassTable style={{ textAlign: "center" }}>
              ...
              <ClassTableTr>
                ...
                <ClassTableTd>
                  ...
                  <br />
                  만약 삽입에 성공하면 true를 반환하고, 큐에 여유 공간이 없어
                  삽입에 실패하면 IllegalStateException을 발생시킴.
                </ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
