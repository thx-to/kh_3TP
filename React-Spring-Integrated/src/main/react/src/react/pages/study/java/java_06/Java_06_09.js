...
import Java_06_09_M from "./Java_06_09_M";
            ...
            <RightContainer>
              <EachClass>
                ...
                <ClassContentsContainer>
                  ...
                  <ClassContentsText>
                    자바의 컬렉션 프레임워크는 컬렉션에 저장된 요소를 읽어오는
                    방법을 Iterator인터페이스로 표준화하고 있습니다.
                    <br />
                    <b>Collection 인터페이스</b>에서는{" "}
                    <b>
                      Iterator 인터페이스를 구현한 클래스의 인스턴스를 반환하는
                      iterator() 메소드를 정의
                    </b>
                    ...
                    따라서{" "}
                    <b>
                      Collection 인터페이스를 상속받는 List와 Set
                      인터페이스에서도 iterator() 메소드를 사용
                    </b>
                    할 수 있습니다.
                    <br />- <ClassContentsCode>hasNext()</ClassContentsCode> :
                    이터레이션(iteration)이 다음 요소를 가지고 있으면 true를
                    반환하고, 더 이상 다음 요소를 가지고 있지 않으면 false를
                    반환함.
                    <br />- <ClassContentsCode>next()</ClassContentsCode> :
                    이터레이션(iteration)의 다음 요소를 반환함.
                    <br />- <ClassContentsCode>remove()</ClassContentsCode> :
                    next()로 읽어온 요소를 삭제함.
                    <Java_06_09_Code02 />
                  </ClassContentsText>
                  <br />
                  ...
                  <ClassContentsText>
                    요소의 선택적 제거나 대체등을 수행하기 위해서는
                    반복자(iterator)사용이 필요 합니다.
                  </ClassContentsText>
                </ClassContentsContainer>
              </EachClass>
              <ArrowContainer>
