    ...
    <Wrap>
      ...
      <Container>
        ...
        <ClassContentsText>
          ...
          데이터를 주고 받는 것 장치와 입출력을 위해서는 하드웨어 장치에 직접
          접근이 필요한데 다양한 매체에 존재하는 데이터들을 사용하기 위해{" "}
        ...
        <ClassContentsText>
          ...
          <br />
          스트림(stream)이란 실제의 입력이나 출력이 표현된 데이터의 이상화된
          흐름을 의미합니다.
          <br />
        ...
        <ClassContentsText>
          스트림 내의 데이터가 모두 전송되기 전까지 프로그램이 지연 상태에 빠질
          수 있다.
        </ClassContentsText>
        <br />
        ...
        <ClassContentsText>
          ...
          <br />- 2차 스트림 : 1차 스트림과 연결을 통해 디바이스와 연결되는
          스트림
        </ClassContentsText>
        <ClassContentsTitle3>전송 방향에 의한 분류</ClassContentsTitle3>
        <ClassContentsText>
          - 입력 스트림 : 디바이스로부터 데이터를 읽어오는 스트림
          <br />- 출력 스트림 : 디바이스로 데이터를 출력하는 스트림
        </ClassContentsText>
        <ClassContentsTitle3>전송단위에 의한 분류</ClassContentsTitle3>
        <ClassContentsText>
          - 바이트 스트림 : 1 Byte 단위로 입력, 출력하는 스트림
          <br />- 문자 스트림 : 한 문자(2 Byte) 단위로 입력, 출력하는 스트림
        </ClassContentsText>
        <ClassContentsTitle3>보조 스트림</ClassContentsTitle3>
        <ClassContentsText>
          스트림의 기능을 향상시키거나 새로운 기능을 추가시키며, 직접적인 데이터
          입출력을 할 수 없다.
        </ClassContentsText>
        <br />
        <hr />
        ...
        <ClassContentsText>
          바이트 단위로 데이터를 전송
          <br />
          바이트 단위로 구성된 파일(동영상, 이미지, 음악 등)을 처리하기에 적합한
          스트림
          <br />
        ...
        <ClassContentsTitle3>OutputStream에 정의된 메소드</ClassContentsTitle3>
        <ClassContentsText>
          <ClassTableBox>
            <ClassTable style={{ textAlign: "center" }}>
              ...
              <ClassTableTr>
                ...
                <ClassTableTd>스트림 버퍼의 내용을 모두 내보냄</ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
                <ClassTableTd>abstract void write(int i)</ClassTableTd>
                <ClassTableTd>주어진 값을 출력</ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
                <ClassTableTd>void write(byte b[])</ClassTableTd>
                <ClassTableTd>배열 b에 저장된 내용을 모두 출력</ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
                <ClassTableTd>
        ...
        <ClassContentsTitle3>배열 전체를 출력하기</ClassContentsTitle3>
        <Java_08_03_Code02 />
        <ClassContentsTitle3>배열 일부를 출력하기</ClassContentsTitle3>
        <Java_08_03_Code03 />
        <br />
        <ClassContentsTitle2>
        ...
        <ClassContentsTitle3>InputStream에 정의된 메소드</ClassContentsTitle3>
        <ClassContentsText>
          <ClassTableBox>
            <ClassTable style={{ textAlign: "center" }}>
              <ClassTableTr>
              ...
              <ClassTableTr>
                ...
                <ClassTableTd>현재 읽을 수 있는 바이트 수를 반환</ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
                <ClassTableTd>void close()</ClassTableTd>
                <ClassTableTd>스트림을 닫음</ClassTableTd>
              ...
              <ClassTableTr>
                ...
                <ClassTableTd>mark()와 reset() 지원 여부 확인</ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
              ...
              <ClassTableTr>
                ...
                <ClassTableTd>
                  배열 b의 크기만큼 읽어서 배열을 채우고 읽은 데이터 수를 반환
                </ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
                <ClassTableTd>
                ...
                <ClassTableTd>
                  최대 len만큼의 바이트를 읽어서 배열 b의 지정된 위치부터 저장
                </ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
        ...
        <Java_08_03_Code04 />
        <ClassContentsTitle3>배열의 길이만큼 읽기</ClassContentsTitle3>
        <Java_08_03_Code05 />
        <ClassContentsTitle3>지정된 길이만큼 읽기</ClassContentsTitle3>
        <Java_08_03_Code06 />
        <br />
        ...
        <ClassContentsText>
          ...
          * StringBufferInputStream과 StringBufferOutputStream은 JDK 1.1부터
          사용되지 않음
        </ClassContentsText>
        <ClassContentsTitle3>
        ...
        <ClassContentsText>
          <ClassTableBox>
            <ClassTable style={{ textAlign: "center" }}>
              ...
              <ClassTableTr>
                <ClassTableTd>abstract void write(int b)</ClassTableTd>
        ...
        <ClassContentsText>
          ...
          <br />
          모든 문자 기반 출력 스트림 클래스는 이 클래스를 상속받아서 만들어
          집니다.
          <br />
          기존 파일 내용 끝에 데이터를 추가할 경우 두번 째 매개값에 true를
          주면됨 <b>(new FileWriter("test.txt", true);)</b>
        </ClassContentsText>
        <ClassContentsTitle3>write(int c) 메소드</ClassContentsTitle3>
        <Java_08_03_Code07 />
        <ClassContentsTitle3>write(char[] c) 메소드</ClassContentsTitle3>
        <Java_08_03_Code08 />
        <ClassContentsTitle3>
        ...
        <ClassContentsText>
          입력 스트림으로 부터 한 개의 문자(2바이트)를 읽고 4바이트 int 타입으로
          리턴 합니다.
          <br />
          read() 메소드가 리턴한 int 값을 char형으로 변환하면 읽은 문자열을 확인
          할 수 있습니다.
          <Java_08_03_Code10 />
        </ClassContentsText>
        <ClassContentsTitle3>read(char[] cbuf) 메소드</ClassContentsTitle3>
        <ClassContentsText>
          입력스트림으로 부터 매개변수로 주어진 문자 배열의 길이만큼 문자를 읽고
          배열에 저장 합니다.
          <br />
          그리고, 읽은 문자 수를 리턴 합니다. 실제로 읽은 문자 수가 배열 길이
          보다 작을 경우 읽은 수만큼만 리턴 합니다.
          <Java_08_03_Code11 />
        </ClassContentsText>
        <br />
        <hr />
        ...
        <ClassContentsText>
          <b>
            파일이나 디렉토리를 추상화한 클래스이며 가장 많이 사용되는 입출력
            대상
          </b>{" "}
          입니다.
        </ClassContentsText>
        <ClassContentsTitle3>File 클래스의 생성자와 메소드</ClassContentsTitle3>
        <ClassContentsText>
          <ClassTableBox>
            <ClassTable style={{ textAlign: "center" }}>
              <ClassTableTr>
              ...
              <ClassTableTr>
                ...
                <ClassTableTd>주어진 파일 이름을 가지는 객체 생성</ClassTableTd>
              </ClassTableTr>
              <ClassTableTr>
                <ClassTableTd>
          ...
          <Java_08_03_Code12 />
          <br />
          <br />- 디렉토리 구분자는 운영체제에 따라 달라 질 수 있습니다.
          <Java_08_03_Code13 />
        </ClassContentsText>
        <br />
        <ClassContentsTitle2>FileInputSteam</ClassContentsTitle2>
        <ClassContentsText>
          파일로부터 바이트 단위로 읽어 들일 때 사용되는 바이트 기반 입력 스트림
          입니다.
          <Java_08_03_Code14 />
        </ClassContentsText>
        <br />
        ...
        <ClassContentsText>
          바이트 단위로 데이터를 파일에 저장 할 때 사용하는 바이트 기반 출력
          스트림 입니다.
          <br />
          바이트 단위로 저장하기 때문에 그림, 오디오, 비디오, 텍스트 등 모든
          종류의 데이터를 파일로 저장 할 수 있습니다.
          <Java_08_03_Code15 />
        </ClassContentsText>
        <br />
        <ClassContentsTitle2>
        ...
        <ClassContentsText>
          ...
          <br />- 스캐너의 hasNextLine()으로 읽을 내용 있는지 확인 합니다.
          <Java_08_03_Code16 />
        </ClassContentsText>
        <br />
        <hr />
        ...
        <ClassContentsText>
          기본 스트림인 InputStream/OutputStream, Reader/Writer를 직접 사용해서
          데이터를 입출력 할 수 있지만,{" "}
          <b>
            데이터 변환해서 입출력하거나, 데이터의 출력 형식을 지정하고 싶은
            경우, 그리고 입출력 성능을 향상시키고 싶을 경우에 기본 스트림에 보조
            스트림을 연결
          </b>
        ...
        <br />
        <ClassContentsTitle2>문자 변환 보조 스트림</ClassContentsTitle2>
        <ClassContentsText>
        ...
        <ClassContentsText>
          - InputStreamReader(InputStream in) : 기본 인코딩을 사용하는 객체를
          생성
          <br />- InputStreamReader(InputStream in, String charsetName) : 지정된
          인코딩을 사용하는 객체를 생성
          <ClassContentsImage
            style={{
              width: "100%",
        ...
        <ClassContentsText>
          - OutputStreamWriter(OutputStream out) : 기본 인코딩을 사용하는 객체를
          생성
          <br />- OutputStreamWriter(OutputStream out, String charsetName) :
          지정된 인코딩을 사용하는 객체 생성
          <ClassContentsImage
            style={{
              width: "100%",
        ...
        <br />
        <ClassContentsTitle2>성능 향상 보조 스트림</ClassContentsTitle2>
        <ClassContentsText>
          프로그램의 실행 성능에서 가능 느린 것이 입출력 장치 입니다. 이를
          해결하기 위해 프로그램이 입출력 소스와 직접 작업하지 않고 중간에
          메모리 버퍼와 작업해 실행 성능을 향상 할 수 있습니다.
        </ClassContentsText>
        <ClassContentsTitle3>
        ...
        <ClassContentsTitle3>버퍼 사용에 따른 성능 비교</ClassContentsTitle3>
        <ClassContentsText>
          <Java_08_03_Code21 />
        </ClassContentsText>
        <br />
        <ClassContentsTitle2>기본 타입 입출력 보조 스트림</ClassContentsTitle2>
        <ClassContentsText>
          바이트 스트림은 바이트 단위로 입출력하기 때문에 자바의 기본 데이터
          타입인 boolean, char, short, int, long, float, double 단위로 입출력 할
          수 없습니다. 그러나 DataInputStream과 DataOutputStream 보조 스트림을
          연결하면 기본 데이터 타입으로 입출력이 가능 합니다.
          <ClassContentsImage
            style={{
              width: "100%",
              height: "150px",
        ...
        <br />
        <ClassContentsTitle2>객체 입출력 보조 스트림</ClassContentsTitle2>
        <ClassContentsTitle3>직렬화와 역직렬화</ClassContentsTitle3>
        <ClassContentsText>
          자바는 메모리에 생성된 객체를 파일 또는 네트워크로 출력 할 수
          있습니다. 객체는 문자가 아니기 때문에 바이트 기반 스트림으로 출력해야
          합니다. 객체를 출력하기 위해서는 일렬로 연속적인 바이트로 변경해야
          하는데, 이것을 <b>객체 직렬화</b>
          라고 합니다. 반대로 파일에 저장되어 있거나 네트워크에서 전송된 객체를
          읽을 수도 있는데, 입력 스트림으로 부터 읽어들인 연속적인 바이트를
          객체로 복원하는 것을 <b>역직렬화</b>라고 합니다.
          <ClassContentsImage
            style={{
              width: "100%",
              height: "150px",
        ...
        <ClassContentsTitle3>직렬화(Serialization)</ClassContentsTitle3>
        <ClassContentsText>
          Serializable 인터페이스를 implements하여 구현 합니다. 객체 직렬화 시
          private 필드를 포함한 모든 필드를 바이트로 변환하지만
          transient키워드를 사용한 필드는 직렬화에서 제외 됩니다.
        </ClassContentsText>
        <ClassContentsTitle3>역직렬화(Deserialization)</ClassContentsTitle3>
        <ClassContentsText>
          직렬화된 객체를 역직렬화할 때는 직렬화 했을 때와 같은 클래스를 사용
          합니다.
          <br />
          단, 클래스 이름이 같더라도 클래스 내용이 변경된 경우 역직렬화가
          실패하게 됩니다.
        </ClassContentsText>
        <ClassContentsTitle3>serialVersionUID 필드</ClassContentsTitle3>
        <ClassContentsText>
          직렬화한 클래스와 같은 클래스임을 알려주는 식별자 역할로 컴파일 시
          JVM이 자동으로 serialViersionUID 정적 필드를 추가해줘 별로도 작성하지
        ...
        <ClassContentsText>
          콘솔은 시스템을 사용하기 위해 키보드로 입력을 받고 화면으로 출력하는
          소프트웨어를 말합니다.
        ...
        <ClassContentsText>
          자바는 프로그램이 콘솔로 부터 데이터 입력을 받을 수 있도록 System
          클래스의 <b>in 정적 필드</b>를 제공하고 있습니다. System.in은
          InputStream 타입의 필드 이므로 다음과 같이 InputStream 변수로 참조
          가능 합니다.
          <Java_08_03_Code26 />
          <Java_08_03_Code27 />
        </ClassContentsText>
        ...
        <ClassContentsText>
          콘솔로 데이터를 출력하기 위해서 System 클래스의 out 정적 필드를 사용
          합니다.
          <Java_08_03_Code28 />
          콘솔로 1개의 바이트를 출력하려면 OutputStream의 write(int b)메소드를
          이용하면 됩니다.
          <br />이 때 바이트 값은 ASCII 코드 인데, write() 메소드는 ASCII 코드를
          문자로 콘솔에 출력 합니다.
          <br />- getBytes() :{" "}
          <b>유니코드 문자열을 바이트코드로 인코딩 해주는 메소드</b> 입니다.
          <Java_08_03_Code29 />
        </ClassContentsText>
        <br />
        <ClassContentsTitle2>
