    ...
    <Wrap>
      ...
      <Container>
        ...
        <ClassContentsText>
          ...
          <br />
          마찬가지로 별도의 Thread를 만들기위해 Thread클래스를 상속받아
          run()메서드를 구현한다.
          <br />
          socket.getIntputStream()을 사용해서 클라이언트에게 데이터를 수신할 수
          있다.
          <Java_09_04_Code01 />
        </ClassContentsText>
        <ClassContentsTitle3>
        ...
        <ClassContentsText>
          ...
          <br />
          별도의 Thread를 만들기위해 Thread클래스를 상속받아 run()메서드를
          구현한다.
          <br />
          socket.getOutputStream()을 사용해서 클라이언트에게 데이터를 전송할 수
          있다.
          <Java_09_04_Code02 />
        </ClassContentsText>
        <ClassContentsTitle3>
